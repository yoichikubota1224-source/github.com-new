...
SRC = {'IDM': 'IDM_全35R_20260830.csv', 'TIME': 'タイム指数_全35R_20260830.csv',
       'UMA': 'ウマトク_全35R_20260830.csv', 'STR': 'スライド競馬新聞_全35R_20260830.csv',
       'JRDB': 'JRDB_基準単複オッズ_全35R_20260830.csv'}
...
json.dump(out, open(os.path.join(os.path.dirname(MB), '統合_20260830.json'), 'w'),
