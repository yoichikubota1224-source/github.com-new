#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""2026-09-05 のJRA公式結果（netkeiba結果ページ）を解析して results_20260906.json を作る。
...
RAW = '/tmp/claude-0/-home-user-github-com-new/47c1892c-ddc4-50e4-8b6f-3403a9782673/scratchpad/res0906'
OUT = os.path.join(os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__)))),
                   'predictions', '20260906', 'results_20260906.json')
